          ...
          class="close" title="Close Modal">&times;</span>
            ...
            <form class="modal-content animate" action="#">
              <div class="imgcontainer">
                <img src="css/img/avatar.png" alt="Avatar" style="height:150px;width:150px" class="img-responsive">
              </div>
    ...
    <input type="email" placeholder="Enter your Email ID" class="form-control" id="email" name="email">
        ...
        <!--/signup-->
              <div class="container">  
                ...
                <div >
    <label for="name">Name:</label>
    <input type="name" placeholder="name" value="&#xe008; name" class="form-control">
  </div>

        <div class="form-group">
    <label for="email">Comment:</label>
    <input type="email" value="&#xf075; Write Something" class="form-control"/>
  </div>
                
                    <b><div type="submit" class="btn btn-danger btn-rounded">Submit <span class="fa fa-telegram"></span></div></b>
